...
public class ReflectionUnitTest {
    ...
    public void givenObject_whenGetsClassName_thenCorrect() {
        ...
        assertEquals("com.peyman.springboot.reflection.Goat", clazz.getName());
        assertEquals("com.peyman.springboot.reflection.Goat", clazz.getCanonicalName());
    }

    @Test
    public void givenClassName_whenCreatesObject_thenCorrect() throws ClassNotFoundException {
        final Class<?> clazz = Class.forName("com.peyman.springboot.reflection.Goat");
    ...
    public void givenClass_whenRecognisesModifiers_thenCorrect() throws ClassNotFoundException {
        final Class<?> goatClass = Class.forName("com.peyman.springboot.reflection.Goat");
        final Class<?> animalClass = Class.forName("com.peyman.springboot.reflection.Animal");
    ...
    public void givenClass_whenGetsPackageInfo_thenCorrect() {
        ...
        assertEquals("com.peyman.springboot.reflection", pkg.getName());
    }
    ...
    public void givenClass_whenGetsConstructor_thenCorrect() throws ClassNotFoundException {
        ...
        assertEquals("com.peyman.springboot.reflection.Goat", constructors[0].getName());
    }
    ...
    public void givenClass_whenGetsAllConstructors_thenCorrect() throws ClassNotFoundException {
        final Class<?> birdClass = Class.forName("com.peyman.springboot.reflection.Bird");
    ...
    public void givenClassField_whenGetsType_thenCorrect() throws Exception {
        final Field field = Class.forName("com.peyman.springboot.reflection.Bird").getDeclaredField("walks");
