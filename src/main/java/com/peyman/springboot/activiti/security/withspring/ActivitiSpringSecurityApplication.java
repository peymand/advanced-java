package com.peyman.springboot.activiti.security.withspring;
...
import com.peyman.springboot.activiti.security.config.SpringSecurityGroupManager;
import com.peyman.springboot.activiti.security.config.SpringSecurityUserManager;

@SpringBootApplication(exclude = SecurityAutoConfiguration.class, scanBasePackages = { "com.peyman.springboot.activiti.security.config", "com.peyman.springboot.activiti.security.withspring" })
